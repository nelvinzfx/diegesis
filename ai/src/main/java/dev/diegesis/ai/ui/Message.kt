package dev.diegesis.ai.ui

import dev.diegesis.ai.util.LocalDateTimeSerializer
...
data class UIMessage(
    ...
    val createdAt: @Serializable(LocalDateTimeSerializer::class) LocalDateTime = LocalDateTime.now(),
    val finishedAt: @Serializable(LocalDateTimeSerializer::class) LocalDateTime? = null,
